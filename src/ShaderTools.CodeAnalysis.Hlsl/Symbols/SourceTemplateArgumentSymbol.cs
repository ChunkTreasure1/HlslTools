...
{
    public sealed class SourceTemplateArgumentSymbol : ParameterSymbol
    {
        internal SourceTemplateArgumentSymbol(TemplateArgumentSyntax syntax, Symbol parent, TypeSymbol valueType, ParameterDirection direction = ParameterDirection.In)
        ...
        public TemplateArgumentSyntax Syntax { get; }
